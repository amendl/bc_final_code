...
if __name__=="__main__":
    ...
    plt.savefig("orders_methanol.png",dpi=300)
    plt.clf()

    fig,ax = plt.subplots(figsize=(2.79077651389/2,2*2*0.9*0.85),constrained_layout=True)
    fig.legend(lines_, [f"DMA order {i}" for i in range(6)] + ["SCF","CCSD(T)"],loc="center")
    plt.axis('off')
    plt.savefig("orders_methanol_legend.png",dpi=300)
