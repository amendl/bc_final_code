...
if __name__=="__main__":
    ...
    data = np.load("../scripts/test_CO2.npy")
    # print(data)
    ...
    plt.legend()
    plt.savefig("CO2_sum_final.png",dpi=300)
    ...
    plt.legend()
    plt.savefig("CO2_sum_differences_final.png",dpi=300)
    ...
    plt.legend()
    plt.savefig("CO2_differences_final.png",dpi=300)
