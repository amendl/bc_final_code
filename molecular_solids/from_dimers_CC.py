...
if __name__=="__main__":
    ...
    # load gdma data
    DMA_entries = [lib.DMA.get_from_gdam_file('/home/users/mendla/work/2/methanol_model_data/CC_gdma_V5Z/' + str(file_index)+'/dma4.punch') for file_index in range(4)]      
