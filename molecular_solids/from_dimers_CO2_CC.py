...
def calculate_dma_energy(data1,data2):
    ...
    return [multipole0,multipole1,multipole2,multipole3]
...
if __name__=="__main__":
    ...
    # load gdma data
    DMA_entries = [lib.DMA.get_from_gdam_file('/home/users/mendla/work/2/CO2_model_data/CC_gdma_V5Z/' + str(file_index)+'/dma4.punch') for file_index in range(4)]      
    ...
    print("Writing")
    with open('test_CO2_CC.npy', 'wb') as f:
        np.save(f,data)
