...
if __name__=="__main__":
    ...
    # load mbe data
    cell=mbe.read_cell('/store/kchfo2/klimj2am/molec_crystals/Me/input/cell')
    coord, elems=mbe.read_monomers_uni('/store/kchfo2/klimj2am/molec_crystals/Me/input')
    with open('/home/users/mendla/work/3/data/new_energies_sym_shell6_test20tig_AVTZ.dat') as f:
        calc_all=f.readlines()

    # load gdma data
    DMA_entries = [lib.DMA.get_from_gdam_file('/home/users/mendla/work/2/Me_model/dma4.punch') for file_index in range(1)]      
