...
if __name__=="__main__":
    ...
    # load gdma data
    DMA_entries = [lib.DMA.get_from_gdam_file('/home/users/mendla/work/2/NH3_model_data/HF_gdma_V5Z/' + str(file_index)+'/dma4.punch') for file_index in range(4)]      
    ...
    print("Writing")
    with open('test_NH3_2.npy', 'wb') as f:
        np.save(f,data)
