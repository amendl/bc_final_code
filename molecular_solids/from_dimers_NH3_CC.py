...
if __name__=="__main__":
    ...
    # load mbe data
    cell=mbe.read_cell('/store/kchfo2/klimj2am/molec_crystals/NH3/GMBE/input/cell')
    coord, elems=mbe.read_monomers_uni('/home/users/mendla/work/3/NH3_input')
    with open('/home/users/mendla/work/3/data/NH3_new_energies_sym_shell6_ref0_test20tig_AVTZ.dat') as f:
        calc_all=f.readlines()

    # load gdma data
    DMA_entries = [lib.DMA.get_from_gdam_file('/home/users/mendla/work/2/NH3_model_data/CC_gdma_V5Z/' + str(file_index)+'/dma4.punch') for file_index in range(4)]      
    ...
    print("Writing")
    with open('test_NH3_CC.npy', 'wb') as f:
        np.save(f,data)
